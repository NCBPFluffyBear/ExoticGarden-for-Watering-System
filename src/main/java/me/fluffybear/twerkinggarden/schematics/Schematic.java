package me.fluffybear.twerkinggarden.schematics;
...
import me.fluffybear.twerkinggarden.TwerkingGarden;
import me.fluffybear.twerkinggarden.schematics.org.jnbt.CompoundTag;
import me.fluffybear.twerkinggarden.schematics.org.jnbt.ShortTag;
import me.fluffybear.twerkinggarden.schematics.org.jnbt.Tag;
...
import me.fluffybear.twerkinggarden.Tree;
import me.fluffybear.twerkinggarden.schematics.org.jnbt.ByteArrayTag;
import me.fluffybear.twerkinggarden.schematics.org.jnbt.NBTInputStream;
...
/**
 * This class was originally written by Max but was modified for TwerkingGarden under the same
...
public class Schematic {
    ...
    public static void pasteSchematic(Location loc, Tree tree) {
        ...
        try {
            ...
            TwerkingGarden.instance.getLogger().log(Level.WARNING, "Could not paste Schematic for Tree: " + tree.getFruitID() + "_TREE (" + e.getClass().getSimpleName() + ')', e);
            return;
        }
